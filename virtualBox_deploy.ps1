...
New-CloneVM -VMSource $VM_SOURCE_SERVER -VMName $VM_SRV_DD -SSHRemotePort 2222 -HTTPRemotePort 8022 -WithNAT $true -WithHostOnly $true
New-CloneVM -VMSource $VM_SOURCE_SERVER -VMName $VM_SRV_FILES -SSHRemotePort 2223 -HTTPRemotePort 8023 -WithNAT $true -WithHostOnly $true
...
Show-White -Message "======================================"
Show-White -Message "======================================"
Show-White -Message "Theses commandes made errors:"
foreach ($command in $operationErrorCommands) {
    Show-Red -Message "[+] ERROR: $command"
}
Show-White -Message "======================================"
Show-White -Message "Deployment finished !"
Show-White -Message "Bye !"
Show-White -Message "======================================"
Show-White -Message ""
